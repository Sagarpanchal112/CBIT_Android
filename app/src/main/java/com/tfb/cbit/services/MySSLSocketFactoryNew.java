 ...
 */
public class MySSLSocketFactoryNew extends SSLSocketFactory {
     ...
     */
    public MySSLSocketFactoryNew(KeyStore truststore) throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
        super(truststore);
    ...
    public static SSLSocketFactory getFixedSocketFactory() {
        ...
        try {
            socketFactory = new MySSLSocketFactoryNew(getKeystore());
    ...
    public static DefaultHttpClient getNewHttpClient(KeyStore keyStore) {
        ...
        try {
            SSLSocketFactory sf = new MySSLSocketFactoryNew(keyStore);
