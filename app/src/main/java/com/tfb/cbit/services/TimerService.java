...
public class TimerService extends Service {
    ...
    public void foreground() {
        ...
        String CHANNEL_ID = "game_active";
        String CHANNEL_NAME = "Game Active";
        ...
        Notification notification =
                new NotificationCompat.Builder(this, CHANNEL_ID)
                        ...
                        .setContentText("Tap to return to game")
                        .setOngoing(true)
    ...
    public void schedule(Context context, String id, String name, String type, long mill) {
        ...
        intent.putExtra(AlarmBroadcastReceiver.TITLE, name);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            AlarmManager.AlarmClockInfo info =
                    new AlarmManager.AlarmClockInfo(mill, alarmPendingIntent);
