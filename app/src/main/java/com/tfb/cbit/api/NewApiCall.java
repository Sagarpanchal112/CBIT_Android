...
import com.tfb.cbit.utility.DownloadApk;
            ...
            call.enqueue(new Callback<ResponseBody>() {
                        ...
                        try {
                            ...
                            switch (commonRes.getStatus()) {
                                ...
                                case Utils.StandardStatusCodes.Update_USER:
                                    ...
                                    customDialog.showDialogOneButton(context, "Update Alert...!", msg,
                                            "OK", new DialogInterface.OnClickListener() {
                                                @Override
                                                public void onClick(DialogInterface dialog, int which) {
                                                    dialog.dismiss();
                                                 /*   Uri uri = Uri.parse("https://cbitoriginal.com/cbit.apk");
                                                    Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                                                    context.startActivity(intent);
                                                */
                                                    String url = "https://cbitoriginal.com/cbitoriginal.apk";
                ...
                public void onFailure(Call<ResponseBody> call, Throwable t) {
                    ...
                    if (call.isCanceled()) {
                        ...
                        Toast.makeText(context, "Your internet connection is to slow to perform this request.", Toast.LENGTH_LONG).show();
                    }
                }
            });
        } else {
