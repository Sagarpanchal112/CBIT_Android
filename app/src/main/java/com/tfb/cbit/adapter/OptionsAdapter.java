...
import com.tfb.cbit.databinding.ItemOptionsBinding;
...
public class OptionsAdapter extends RecyclerView.Adapter<OptionsAdapter.ViewHolder> {
    ...
    public OptionsAdapter(Context context, List<Slote> sloteList) {
        this.context = context;
        this.sloteList = sloteList;
    }
    public OptionsAdapter(Context context, List<Slote> sloteList,String gameStatus) {
        this.context = context;
        this.sloteList = sloteList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ItemOptionsBinding
                binding = ItemOptionsBinding.inflate(LayoutInflater.from(viewGroup.getContext()), viewGroup, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull ItemOptionsBinding binding) {
