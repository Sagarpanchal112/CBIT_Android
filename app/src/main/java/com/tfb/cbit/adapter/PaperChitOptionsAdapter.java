...
import com.tfb.cbit.databinding.ItemPaperOptionsBinding;
...
public class PaperChitOptionsAdapter extends RecyclerView.Adapter<PaperChitOptionsAdapter.ViewHolder> {
    ...
    public PaperChitOptionsAdapter(Context context, List<Slote> sloteList) {
        this.context = context;
        this.sloteList = sloteList;
    }

    public PaperChitOptionsAdapter(Context context, List<Slote> sloteList, String gameStatus) {
        this.context = context;
        this.sloteList = sloteList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ItemPaperOptionsBinding binding = ItemPaperOptionsBinding.inflate(LayoutInflater.from(viewGroup.getContext()), viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
     ...
     /*   if(sloteList.get(i).getDisplayValue().length()>1) {
        ...
        render.setAnimation(Flip.OutX(viewHolder.binding.ivImage));
        render.start();
             /*   render.setAnimation(Zoom.Out(imageView));
                render.start();
            */
        viewHolder.binding.ivVadapav.setVisibility(View.VISIBLE);
        render.setAnimation(Flip.InY(viewHolder.binding.ivVadapav));
        render.start();
        viewHolder.binding.ivImage.setVisibility(View.GONE);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ItemPaperOptionsBinding binding;
        public ViewHolder(@NonNull ItemPaperOptionsBinding binding) {
