...
public class EasyContestPriceAdapter extends RecyclerView.Adapter<EasyContestPriceAdapter.ViewHolder> {
    private Context context;
    private List<EasyJoinModel.PrinceData> groupName;
    private OnItemClickListener onItemClickListener;

    public EasyContestPriceAdapter(Fragment context, List<EasyJoinModel.PrinceData> groupName) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        viewHolder.binding.tvGamePrice.setText(Utils.getTwoDecimalFormat(Float.parseFloat(String.valueOf(groupName.get(i).getAmount()))));
