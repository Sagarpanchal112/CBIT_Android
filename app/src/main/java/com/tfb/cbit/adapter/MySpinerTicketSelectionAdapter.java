...
public class MySpinerTicketSelectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MySpinerTicketSelectionAdapter(Context context, List<Ticket> ticketList) {
...
//            }
        ...
        fixedHolder.binding.rvOprions.setAdapter(new SpiningOptionsAdapter(context, ticketList.get(i).getSlotes(), Utils.GAME_NOT_START));
      ...
      //      fixedHolder.frmSelected.setBackgroundColor(ContextCompat.getColor(context, R.color.transparent_white));
            fixedHolder.chkSelect.setVisibility(View.GONE);
            ...
            fixedHolder.chkSelect.setVisibility(View.VISIBLE);
            fixedHolder.frmSelected.setVisibility(View.GONE);
