...
public class SpiningOptionsAdapter extends RecyclerView.Adapter<SpiningOptionsAdapter.ViewHolder> {
    ...
    public SpiningOptionsAdapter(Context context, List<Slote> sloteList) {
        this.context = context;
        this.sloteList = sloteList;
    }

    public SpiningOptionsAdapter(Context context, List<Slote> sloteList, String gameStatus) {
        this.context = context;
        this.sloteList = sloteList;
        this.gameStatus = gameStatus;
    }

    public SpiningOptionsAdapter(Context context, String gameStatus) {
        this.context = context;
        this.gameStatus = gameStatus;
    }
