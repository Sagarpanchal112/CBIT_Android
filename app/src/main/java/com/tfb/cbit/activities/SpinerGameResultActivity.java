...
import com.tfb.cbit.databinding.ActivitySpinerGameResultBinding;
...
public class SpinerGameResultActivity extends BaseAppCompactActivity implements OnItemClickListener {
 ...
 //   protected PowerManager.WakeLock mWakeLock;
    ...
    private ActivitySpinerGameResultBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      */    binding = ActivitySpinerGameResultBinding.inflate(getLayoutInflater());
