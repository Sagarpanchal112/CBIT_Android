...
import com.tfb.cbit.adapter.MySpinerTicketSelectionAdapter;
...
public class MySpinningTicketsActivity extends BaseAppCompactActivity implements OnItemClickListener {
    private static final String TAG = "MyTicketsActivity";
    private MySpinerTicketSelectionAdapter myTicketAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTicketAdapter = new MySpinerTicketSelectionAdapter(context, ticketList);
        ...
        binding.linearBuyMore.setOnClickListener(view -> {
            Intent intent = new Intent(context, SpiningTicketSelectionActivity.class);
            intent.putExtra(SpiningTicketSelectionActivity.CONTEST_ID, contestId);
            intent.putExtra(SpiningTicketSelectionActivity.CONTEST_NAME, binding.toolbarTitle.getText().toString());
            intent.putExtra(SpiningTicketSelectionActivity.CONTEST_RTIME, bundle.getString(CONTEST_RTIME, ""));
            ...
            public void success(String responseData) {
                ...
                if (gtm.getStatusCode() == Utils.StandardStatusCodes.SUCCESS) {
                    ...
                    if (counter == gtm.getContent().getTickets().size()) {
                        ...
                        binding.linearBuyMore.setVisibility(View.VISIBLE);
                    }
                    if (counter <= 1) {
