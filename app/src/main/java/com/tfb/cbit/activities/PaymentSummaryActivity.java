...
import com.tfb.cbit.databinding.ActivityPaymentSummaryBinding;
...
public class PaymentSummaryActivity extends BaseAppCompactActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPaymentSummaryBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        context = this;
        sessionUtil = new SessionUtil(context);
        if (!EventBus.getDefault().isRegistered(this))
            EventBus.getDefault().register(this);
        binding.tvWallet.setText(String.valueOf("Wallet " + (Utils.getCurrencyFormat(String.valueOf(Double.parseDouble(sessionUtil.getAmount()) + Double.parseDouble(sessionUtil.getWAmount()))))));
        ...
        binding.btnWallet.setOnClickListener(view -> {
            Intent intent = new Intent(context, HomeActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            intent.putExtra("screen", getString(R.string.wallet));
            startActivity(intent);
            finish();
        });
        binding.btnWallet.setOnClickListener(view -> {
