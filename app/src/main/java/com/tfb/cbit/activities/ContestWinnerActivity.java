...
public class ContestWinnerActivity extends BaseAppCompactActivity implements WinnerAdapter.OnLoadMoreListener {
    ...
    private void getWinnerData(boolean isLoadMore) {
        ...
        Call<ResponseBody> call = APIClient.getInstance()
                .winnerList(sessionUtil.getToken(), sessionUtil.getId(), request);
