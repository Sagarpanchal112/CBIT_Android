            ...
            public void success(String responseData) {
                ...
                if (gtm.getStatusCode() == Utils.StandardStatusCodes.SUCCESS) {
                    ...
                    if (gtm.getContent().getGame_type().equals("rdb")) {
                        ...
                        binding.tvTitle.setText("Blue-Red");

                    }
                    binding.tvWinnings.setText("Win Amount : " + Utils.INDIAN_RUPEES + gtm.getContent().getTotalWinAmount());
                    binding.tvCCWinnings.setText("Cashback points : " + gtm.getContent().getTotalCCWinAmount()+" Points");
                   ...
                   /* if (isWin(gtm.getContent().getAnswer())) {
                        tvAns.setText("You chose right answer in " + gtm.getContent().getTickets().get(0).getLockTime() + "");
                    } else {
                        tvAns.setText("You chose wrong answer in " + gtm.getContent().getTickets().get(0).getLockTime() + "");
