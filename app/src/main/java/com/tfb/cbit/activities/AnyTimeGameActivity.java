...
import com.tfb.cbit.databinding.ActivityAnyTimeGameBinding;
...
public class AnyTimeGameActivity extends BaseAppCompactActivity implements OnItemClickListener, OnItemLongClickListener {
    ...
    String game_type;
    private ActivityAnyTimeGameBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAnyTimeGameBinding.inflate(getLayoutInflater());
        ...
        ticketSelectionAdapter = new AnyTicketSelectionAdapter(context, anyticketList);
